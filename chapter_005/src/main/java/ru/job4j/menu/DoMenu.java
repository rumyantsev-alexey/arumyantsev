...
public class DoMenu {
     ...
     * @param menu меню
     */
    public DoMenu(final Menu menu) {
        this.menu = menu;
        List<Node> m = menu.getAllMenu(menu.getRoot());
     ...
     */
    public Node runMenu(final InputStream in, final PrintStream out) {
        Node result = null;
        String input;
        System.setOut(out);
    ...
    public static void main(String[] args) {
        ...
        f3.addNodes(List.of(new Node("Third21"),
                            new Node("Third22")));
        test.getRoot().addNodes(List.of(f1, f2, f3));
        DoMenu run = new DoMenu(test);
        run.runMenu(System.in, System.out);
    }
}
